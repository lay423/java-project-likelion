package algorithm.week3.java1007.population;
...
public class PopulationStatistics {
    ...
    public static void setSidoMap(){
        PopulationMove.sidoMap.put(11,	"서울특별시");
        PopulationMove.sidoMap.put(26,	"부산광역시");
        PopulationMove.sidoMap.put(27,	"대구광역시");
        PopulationMove.sidoMap.put(28,	"인천광역시");
        PopulationMove.sidoMap.put(29,	"광주광역시");
        PopulationMove.sidoMap.put(30,	"대전광역시");
        PopulationMove.sidoMap.put(31,	"울산광역시");
        PopulationMove.sidoMap.put(41,	"경기도");
        PopulationMove.sidoMap.put(42,	"강원도");
        PopulationMove.sidoMap.put(43,	"충청북도");
        PopulationMove.sidoMap.put(44,	"충청남도");
        PopulationMove.sidoMap.put(45,	"전라북도");
        PopulationMove.sidoMap.put(46,	"전라남도");
        PopulationMove.sidoMap.put(47,	"경상북도");
        PopulationMove.sidoMap.put(48,	"경상남도");
        PopulationMove.sidoMap.put(50,	"제주특별자치도");
